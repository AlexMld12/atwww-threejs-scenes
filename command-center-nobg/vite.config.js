...
// any URL (e.g. https://USER.github.io/<repo>/command-center-nobg/).
//
...
export default defineConfig({
  ...
  server: {
    host: true,
    port: 5174,   // 5173 belongs to command-center-slider — both can run at once
  },
  build: {
    ...
    // fixed jsDelivr URL (…/assets/command-center-nobg.js) that doesn't change
    // every build. Cache-busting on deploy is handled by pinning the jsDelivr
    // URL to a git tag/commit instead of by the filename hash.
    rollupOptions: {
      output: {
        entryFileNames: 'assets/command-center-nobg.js',
